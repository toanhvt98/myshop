    ...
    try:
        with transaction.atomic():
            ...
            context = {
                'subject': subject,
                'user':user,
                'language': user.profile.language or current_language_code or language_config['LANGUAGE_CODE'],
            ...
            with get_connection(
                ...
                with translation.override(context['language']):
                    html_content = render_to_string('user_app/otp_verify_login.html', context)
